...
valid_experiments <- experiments[experiments$col_block_size <= experiments$image_size &&
                                 experiments$row_block_size <= experiments$image_size &&
                                 (experiments$image_size / experiments$row_block_size) %% experiments$processors == 0,]
